...
public class ConnectDevDialogFragment extends DialogFragment implements AdapterView.OnItemSelectedListener
{
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState)
  {
    ...
    ArrayAdapter<String> devSpinAdapter = new ArrayAdapter<String>(ConnectDevDialogFragment.this.getActivity(), android.R.layout.simple_spinner_item,
        populateDevices(devices.keySet()));
  ...
  public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
  {
    switch (parent.getId())
    {
      case R.id.spin_device:
        ...
        ArrayAdapter<String> daSpinAdapter = new ArrayAdapter<String>(ConnectDevDialogFragment.this.getDialog().getContext(), android.R.layout.simple_spinner_item,
            devices.get(devId));
