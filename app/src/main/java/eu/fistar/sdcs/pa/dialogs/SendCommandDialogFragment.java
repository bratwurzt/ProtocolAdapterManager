...
public class SendCommandDialogFragment extends DialogFragment implements AdapterView.OnItemSelectedListener
{
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState)
  {
    ...
    ArrayAdapter<String> devSpinAdapter = new ArrayAdapter<String>(SendCommandDialogFragment.this.getActivity(), android.R.layout.simple_spinner_item,
        populateDevices(devsCommands.keySet()));
  ...
  public void onItemSelected(AdapterView<?> parent, View view, int pos, long id)
  {
    switch (parent.getId())
    {
      case R.id.spin_device:
        ...
        ArrayAdapter<String> commSpinAdapter = new ArrayAdapter<String>(SendCommandDialogFragment.this.getDialog().getContext(), android.R.layout.simple_spinner_item,
            devsCommands.get(devId));
